...
<div id="{{ $id }}"
    ...
    data-original-confirm-text="{{ $confirmText }}">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-xl shadow-xl
        ...
        <form method="POST" 
            ...
            action="{{ $action }}"
            data-original-action="{{ $action }}"
            data-original-method="{{ $method }}"
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white modal-title">{{ $title }}</h2>
            ...
            <div class="flex justify-end gap-3">
                ...
                <button type="button" onclick="openConfirmModal('{{ $idConfirmModal }}', this)"
                    ...
                    data-original-text="{{ $confirmText }}">
